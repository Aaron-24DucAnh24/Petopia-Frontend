...
const TermsOfUse: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 w-3/4">
      <h1 className="font-bold text-3xl mb-4">Điều khoản sử dụng</h1>
      <div className="text-justify">
        ...
        <p>
          ...
          mọi thông tin càng chính xác càng tốt, chúng tôi luôn khuyến nghị
          gọi cho cơ sở hoặc tổ chức cứu hộ chăm sóc thú cưng để đảm bảo
          nó vẫn có sẵn. Đó là trách nhiệm duy nhất của bất kỳ người nào
          xem trang web này để xác minh tính chính xác và đầy đủ của
          thông tin chứa trong đó trước khi thực hiện bất kỳ hành động nào.
        </p>
        ...
        <p>
          ...
          Petopia không chịu trách nhiệm về bất kỳ trách nhiệm pháp lý nào đối với
          bất kỳ thương tích hoặc thiệt hại nào đối với bất kỳ người hoặc tài sản nào gây ra bởi bất kỳ hành vi nào được liệt kê
          động vật. Petopia không chịu trách nhiệm về bất kỳ trách nhiệm pháp lý nào
          bất cứ điều gì vì bất kỳ nguyên nhân hành động, khiếu nại, vụ kiện hoặc yêu cầu nào có thể
          phát sinh do bất kỳ tổn thương, mất mát hoặc thiệt hại nào nói trên,
        ...
        <p>
          ...
          xuất bản bất kỳ tài liệu nào mà Petopia giữ bản quyền.
        ...
        <p>
          ...
          họ. Các liên kết bên ngoài được cung cấp hoàn toàn cho mục đích thông tin
          chỉ một.
        </p>
